...
tt.target = nil
tt.done = nil
tt = E:register_t("tower_hover_controller")

E:add_comps(tt, "main_script", "render", "tween")

tt.main_script.insert = scripts.tower_hover_controller.insert
tt.main_script.update = scripts.tower_hover_controller.update
tt.render.sprites[1].animated = false
...
local fx_unit_explode = E:register_t("fx_dragon_geiser_explode", "fx")

fx_unit_explode.render.sprites[1].prefix = "hero_murglun_geiser"
fx_unit_explode.render.sprites[1].name = "run"
fx_unit_explode.render.sprites[1].anchor.y = 0.22
fx_unit_explode.render.sprites[1].z = Z_OBJECTS
--fx_unit_explode.render.sprites[1].draw_order = 1

local fx_unit_explode = E:register_t("fx_dragon_geiser_explode_ash", "fx")

fx_unit_explode.render.sprites[1].prefix = "hero_murglun_geiser_death"
fx_unit_explode.render.sprites[1].name = "run"
fx_unit_explode.render.sprites[1].anchor.y = 0.22
fx_unit_explode.render.sprites[1].z = Z_OBJECTS
--fx_unit_explode.render.sprites[1].draw_order = 1
...
tt.render.sprites[3].scale = vv(0.7)
...
E:add_comps(tt, "pos", "tower", "main_script", "render", "tween", "sound_events")
...
--E:add_comps(tower, "tower", "pos", "render", "main_script", "ui", "info", "sound_events", "editor", "editor_script","tower_upgrade_persistent_data")
...
unit.health_bar.z = Z_FLYING_HEROES
...
tt.info.portrait = IS_KR1 and "info_portraits_sc_0001" or "info_portraits_soldiers_0001"
...
tt.info.portrait = IS_KR1 and "info_portraits_sc_0002" or "info_portraits_soldiers_0002"
...
tt.info.portrait = IS_KR1 and "info_portraits_sc_0003" or "info_portraits_soldiers_0003"
...
if IS_KR1 or IS_KR2 then
	...
	tt.info.enc_icon = 254
	tt.main_script.insert = scripts.enemy_basic.insert
	tt.main_script.update = scripts.enemy_mixed.update
	tt.melee.attacks[1].cooldown = 2
	tt.melee.attacks[1].damage_max = 55
	tt.melee.attacks[1].damage_min = 45
	...
	tt = E:register_t("enemy_abomination_1", "enemy")
	...
	tt = E:register_t("enemy_werewolf_1", "enemy")
	...
	tt.render.sprites[1].name = "raise" -- rime_light 补一下动画
	tt.render.sprites[1].anchor.y = anchor_y
	...
	tt = E:register_t("enemy_halloween_zombie_1", "enemy")
	...
	tt = E:register_t("enemy_lycan_1", "enemy")
	...
	tt.melee.attacks[1].damage_min = 10
	tt.melee.attacks[1].hit_time = fts(10)
	tt.moon.transform_name = "enemy_lycan_werewolf_1"
	tt.motion.max_speed = 1.28 * 1 * FPS
	tt.render.sprites[1].prefix = "enemy_lycan"
	tt.render.sprites[1].anchor.y = anchor_y
	tt.unit.blood_color = BLOOD_RED
	...
	tt = E:register_t("enemy_lycan_werewolf_1", "enemy")
