...
function U.melee_slot_position(soldier, enemy, rank, back)
	...
	local soldier_pos
	if enemy.enemy and enemy.enemy.melee_slot then
		soldier_pos = V.v(enemy.pos.x + (enemy.enemy.melee_slot.x + x_off + soldier.soldier.melee_slot_offset.x) * (soldier_on_the_right and 1 or -1), enemy.pos.y + enemy.enemy.melee_slot.y + y_off + soldier.soldier.melee_slot_offset.y)
	else
		soldier_pos = V.v(enemy.pos.x, enemy.pos.y)
	end
