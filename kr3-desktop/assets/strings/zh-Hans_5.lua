return {
	...
	HERO_BIRD_BIRDS_OF_PREY_DESCRIPTION_3 = "召唤狮鹫飞到区域上空攻击敌人，持续%$heroes.hero_bird.ultimate.bird.duration[3]%$秒，每次攻击造成%$heroes.hero_bird.ultimate.bird.melee_attack.damage_max[3]%$点伤害。",
	...
	HERO_BUILDER_WRECKING_BALL_DESCRIPTION_3 = "朝路径上扔出一个巨大钢球，造成%$heroes.hero_builder.ultimate.damage[3]%$点物理伤害，并使敌人眩晕%$heroes.hero_builder.ultimate.stun_duration[3]%$秒。",
	...
	["HERO_DRAGON_ARB_ARBOREAN EVOLVE_DESCRIPTION_1"] = "希尔瓦拉释放她的真实形态，持续%$heroes.hero_dragon_arb.ultimate.duration[1]%$秒，在此期间她获得%$heroes.hero_dragon_arb.ultimate.s_bonuses[1]%$%伤害、速度、抗性提升，并强化一部分技能。",
	["HERO_DRAGON_ARB_ARBOREAN EVOLVE_DESCRIPTION_2"] = "希尔瓦拉释放她的真实形态，持续%$heroes.hero_dragon_arb.ultimate.duration[2]%$秒，在此期间她获得%$heroes.hero_dragon_arb.ultimate.s_bonuses[2]%$%伤害、速度、抗性提升，并强化一部分技能。",
	["HERO_DRAGON_ARB_ARBOREAN EVOLVE_DESCRIPTION_3"] = "希尔瓦拉释放她的真实形态，持续%$heroes.hero_dragon_arb.ultimate.duration[3]%$秒，在此期间她获得%$heroes.hero_dragon_arb.ultimate.s_bonuses[3]%$%伤害、速度、抗性提升，并强化一部分技能。",
	...
	HERO_DRAGON_BONE_RAISE_DRAKES_DESCRIPTION_3 = "召唤两只小骨龙，每只拥有%$heroes.hero_dragon_bone.ultimate.dog.hp[3]%$点生命值，攻击造成%$heroes.hero_dragon_bone.ultimate.dog.melee_attack.damage_min[3]%$-%$heroes.hero_dragon_bone.ultimate.dog.melee_attack.damage_max[3]%$点物理伤害。",
	...
	HERO_DRAGON_GEM_FALLING_CRYSTALS_DESCRIPTION_3 = "召唤%$heroes.hero_dragon_gem.ultimate.max_shards[3]%$根水晶锥，对范围内的敌人造成%$heroes.hero_dragon_gem.ultimate.damage_min[3]%$-%$heroes.hero_dragon_gem.ultimate.damage_max[3]%$点真实伤害。",
	...
	HERO_HUNTER_SPIRIT_DESCRIPTION_3 = "召唤但丁的幻影，每秒造成%$heroes.hero_hunter.ultimate.entity.basic_ranged.damage_min[3]%$-%$heroes.hero_hunter.ultimate.entity.basic_ranged.damage_max[3]%$点真实伤害，持续%$heroes.hero_hunter.ultimate.duration%$秒。若安雅的遗体在其附近，将会被复活。",
	...
	HERO_LAVA_ULTIMATE_DESCRIPTION_3 = "向路径喷射%$heroes.hero_lava.ultimate.fireball_count[3]%$发熔岩弹，每发对敌人造成%$heroes.hero_lava.ultimate.bullet.s_damage[3]%$点真实伤害，并使其灼烧%$heroes.hero_lava.ultimate.bullet.scorch.duration%$秒。",
	...
	HERO_MECHA_DEATH_FROM_ABOVE_DESCRIPTION_3 = "呼叫一架哥布林飞艇，对目标范围附近的敌人进行轰炸，每次攻击造成%$heroes.hero_mecha.ultimate.ranged_attack.damage_min[3]%$-%$heroes.hero_mecha.ultimate.ranged_attack.damage_max[3]%$点真实范围伤害。",
	...
	HERO_MUYRN_ROOT_DEFENDER_DESCRIPTION_3 = "在一定范围内生成树根，持续%$heroes.hero_muyrn.ultimate.duration[3]%$秒，减速敌人，且每秒造成%$heroes.hero_muyrn.ultimate.s_damage_min[3]%$-%$heroes.hero_muyrn.ultimate.s_damage_max[3]%$点真实伤害。",
	...
	HERO_RAELYN_COMMAND_ORDERS_DESCRIPTION_3 = "召唤一名黑暗骑士，其拥有%$heroes.hero_raelyn.ultimate.entity.hp_max[3]%$点生命值，攻击可造成%$heroes.hero_raelyn.ultimate.entity.damage_min[3]%$-%$heroes.hero_raelyn.ultimate.entity.damage_max[3]%$点真实伤害。",
	...
	HERO_SPACE_ELF_COSMIC_PRISON_DESCRIPTION_3 = "将一群敌人困在虚空中%$heroes.hero_space_elf.ultimate.duration[3]%$秒，并造成%$heroes.hero_space_elf.ultimate.damage[3]%$点伤害。",
	...
	HERO_SPIDER_ARACNID_SPAWNER_DESCRIPTION_3 = "召唤%$heroes.hero_spider.ultimate.spawn_amount[3]%$只蜘蛛，持续战斗%$heroes.hero_spider.ultimate.spider.duration[3]%$秒，蜘蛛攻击敌人时使其眩晕。",
	...
	HERO_VENOM_CREEPING_DEATH_DESCRIPTION_3 = "在一定范围散布粘稠物质，使敌人减速，片刻之后转化为穿刺尖刺，对敌人造成%$heroes.hero_venom.ultimate.s_damage[3]%$点真实伤害。",
	...
	HERO_VESPER_ARROW_STORM_DESCRIPTION_3 = "朝一片区域倾泻%$heroes.hero_vesper.ultimate.s_spread[3]%$支箭矢，每支对敌人造成%$heroes.hero_vesper.ultimate.damage[3]%$点物理伤害。",
	...
	HERO_WITCH_ULTIMATE_DESCRIPTION_3 = "将%$heroes.hero_witch.ultimate.max_targets[3]%$名敌人往回传送，传送后使其昏睡%$heroes.hero_witch.ultimate.duration[3]%$秒。",
	...
	HERO_WUKONG_ULTIMATE_DESCRIPTION_3 = "小白龙从天而降，猛扎进地面，造成%$heroes.hero_wukong.ultimate.damage_total[3]%$点真实伤害，并留下减速区域。",
	...
	TOWER_ARCANE_WIZARD_1_DESCRIPTION = "精通奥术的巫师，随时随地都能从容应战。",
	TOWER_ARCANE_WIZARD_1_NAME = "奥术巫师I",
	TOWER_ARCANE_WIZARD_2_DESCRIPTION = "精通奥术的巫师，随时随地都能从容应战。",
	TOWER_ARCANE_WIZARD_2_NAME = "奥术巫师II",
	TOWER_ARCANE_WIZARD_3_DESCRIPTION = "精通奥术的巫师，随时随地都能从容应战。",
	TOWER_ARCANE_WIZARD_3_NAME = "奥术巫师III",
	TOWER_ARCANE_WIZARD_4_DESCRIPTION = "精通奥术的巫师，随时随地都能从容应战。",
	...
	TOWER_ARCANE_WIZARD_4_NAME = "奥术巫师IV",
	TOWER_ARCANE_WIZARD_DESC = "利尼维亚的法师能够运用纯粹的魔法，彻底摧毁他们的敌人。",
	TOWER_ARCANE_WIZARD_NAME = "奥术巫师",--"奥术法师",
	...
	---
	BLOCKED_ELEMENTAL_TOWER_NAME = "龙魂宝壶",
	BLOCKED_ELEMENTAL_TOWER_METAL_NAME = "龙魂宝壶：金",
	BLOCKED_ELEMENTAL_TOWER_WOOD_NAME = "龙魂宝壶：木",
	BLOCKED_ELEMENTAL_TOWER_WATER_NAME = "龙魂宝壶：水",
	BLOCKED_ELEMENTAL_TOWER_FIRE_NAME = "龙魂宝壶：火",
	BLOCKED_ELEMENTAL_TOWER_EARTH_NAME = "龙魂宝壶：土",
}