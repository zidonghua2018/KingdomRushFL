...
function MapView:show_flags(num)
	...
	local level_rank = map_data.level_rank
...
function LevelSelectView:initialize(sw, sh, level_num, stars, heroic, iron, slot_data)
	...
	if screen_map.kr1_map then
		level_num = level_rank(local_level_num, 1)
		local_generation = 1
	elseif screen_map.kr2_map then
		level_num = level_rank(local_level_num, 2)
		local_generation = 2
	elseif screen_map.kr5_map then
		level_num = level_rank(local_level_num, 5)
		local_generation = 5
	else
		level_num = level_rank(local_level_num, 3)
	end
