-- chunkname: @./kr5/screen_boss_fight_7_end.lua
...
function screen:next_item()
	...
	if self.phase == "comic14" then
		screen_comics.comic_data = love.filesystem.read(director:get_comic_data_file(14))
