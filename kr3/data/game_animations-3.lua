...
local a = {
	...
	hero_alleria_g3_idle = {
		prefix = "hero_alleria",
		to = 1,
		from = 1
	},
	hero_alleria_g3_walk = {
		prefix = "hero_alleria",
		to = 6,
		from = 2
	},
	hero_alleria_g3_shoot = {
		prefix = "hero_alleria",
		to = 24,
		from = 7
	},
	hero_alleria_g3_attack = {
		prefix = "hero_alleria",
		to = 51,
		from = 25
	},
	hero_alleria_g3_shootSpecial = {
		prefix = "hero_alleria",
		to = 74,
		from = 52
	},
	hero_alleria_g3_death = {
		prefix = "hero_alleria",
		to = 88,
		from = 75
	},
	hero_alleria_g3_respawn = {
		prefix = "hero_alleria",
		to = 112,
		from = 89
	},
