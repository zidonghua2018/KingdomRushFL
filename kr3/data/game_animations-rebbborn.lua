...
---叶脉
	soldier_s16_ground_archer_idleUp = {
		prefix = "groundArchers_shooter",
		to = 15,
		from = 15
	},	
	soldier_s16_ground_archer_idleDown = {
		prefix = "groundArchers_shooter",
		to = 15,
		from = 15
	},
	soldier_s16_ground_archer_shootingUp = {
		prefix = "groundArchers_shooter",
		to = 15,
		from = 1
	},
	soldier_s16_ground_archer_shootingDown = {
		prefix = "groundArchers_shooter",
		to = 15,
		from = 1
	},
	soldier_s16_ground_archer_multishot = {
		prefix = "groundArchers_multishot",
		to = 17,
		from = 1
	},				
	fx_groundArchers_hit = {
		prefix = "groundArchers_proy",
		to = 6,
		from = 2
	},
	archer_green_explosion = {
		prefix = "archer_green_explosion",
		to = 14,
		from = 1
	},				    
---阿渥克1.5
