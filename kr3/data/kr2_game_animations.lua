return {
	...
	big_hero_dwarf_idle = {
		from = 1,
		prefix = "BigDwarfChampion",
		to = 1,
	},
	big_hero_dwarf_running = {
		from = 2,
		prefix = "BigDwarfChampion",
		to = 6,
	},
	big_hero_dwarf_attack = {
		from = 7,
		prefix = "BigDwarfChampion",
		to = 25,
	},
	big_hero_dwarf_attack2 = {
		from = 25,
		prefix = "BigDwarfChampion",
		to = 71,
	},
	...
	enemy_saurian_king_walkingUp = {
		from = 2,
		prefix = "saurianMiniBoss",
		to = 25,
	},	
	enemy_saurian_king_attack = {
		from = 93,
		prefix = "saurianMiniBoss",
		to = 130,
	},
	enemy_saurian_king_hammer_start = {
		from = 50,
		prefix = "saurianMiniBoss",
		to = 54,
	},
	enemy_saurian_king_death = {
		from = 131,
		prefix = "saurianMiniBoss",
		to = 195,
	},
	enemy_saurian_king_idle = {
		from = 1,
		prefix = "saurianMiniBoss",
		to = 1,
	},
	enemy_saurian_king_walkingRightLeft = {
		from = 2,
		prefix = "saurianMiniBoss",
		to = 25,
	},
	enemy_saurian_king_hammer_loop = {
		from = 55,
		prefix = "saurianMiniBoss",
		to = 92,
	},
	enemy_saurian_king_walkingDown = {
		from = 26,
		prefix = "saurianMiniBoss",
		to = 49,
	},
	decal_enemy_saurian_king_hammer = {
		from = 1,
		prefix = "saurianMiniBoss_effect",
		to = 20,
	},
	-- customization
