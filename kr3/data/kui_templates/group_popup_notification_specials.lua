...
return {
	...
	children = {
		...
		{
			template_name = "group_special_polaroid",
			class = "KView",
			r = 0.0447,
			id = "polaroid",
			pos = v(-411.7, 1.6),
		...
		},
		{
			vertical_align = "top",
			text_align = "left",
			text_key = "NOTIFICATION_special_desc_bullets",
			font_size = 28,
			line_height_extra = "-5",
			text = "Demons are free and you can call them every 15 seconds\nthem every 15 secondsv",
			class = "GG5Label",
			id = "label_special_desc_bullets",
			fit_size = true,
			font_name = "fla_body",
			pos = v(-171.95, 44.25),
			size = v(635.95, 125.9),
		...
		},
		{
			vertical_align = "top",
			text_align = "left",
			text_key = "NOTIFICATION_special_desc_body",
			font_size = 32,
			line_height_extra = "-5",
			text = "You can summon troops to help you on the battlefield.\nhelp you on the battlefield.\n",
			class = "GG5Label",
			id = "label_special_desc_body",
			fit_size = true,
			font_name = "fla_body",
			pos = v(-171.35, -119.4),
			size = v(636.15, 168.8),
		...
		{
			text_key = "NOTIFICATION_special_desc_title",
			text_align = "left",
			line_height_extra = "2",
			font_size = 42,
			text = "Call reinforcements",
			class = "GG5Label",
			id = "label_special_desc_title",
			fit_size = true,
			font_name = "fla_body",
			pos = v(-171.35, -185.25),
			size = v(638.1, 63),
		...
		},
		{
			...
			line_height_extra = "2",
			fit_size = true,
			text = "Special unlocked",
			text_key = "NOTIFICATION_title_special",
			class = "GG5ShaderLabel",
			id = "label_title_special",
			font_name = "fla_h",
			pos = v(-286.2, -307.65),
			scale = v(1.0322, 1),
			size = v(573.6, 53.65),
