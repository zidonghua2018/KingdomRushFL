-- chunkname: @./kr5/data/kui_templates/group_shop_offers_spider.lua
...
return {
	...
	children = {
		...
		{
			class = "GG5Button",
			template_name = "button_shop_offers_spiders",
		...
		{
			class = "KImageView",
			image_name = "shop_room_image_spiders_art_right  _",
			pos = v(332.8, 77.55),
			anchor = v(186.5, 265.25)
		},
		{
			class = "KImageView",
			image_name = "shop_room_image_spiders_art_left _",
			pos = v(-348.15, 51.55),
