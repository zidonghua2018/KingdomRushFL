					...
					children = {
						{
							...
							children = {
								...
								},
								{
									...
									text_align = "left",
									font_name = "body_bold",
									text = _(string.upper(ctx.prefixes[1]) .. "_NAME"),
									colors = {
										text = {
											24,
											26,
								...
								},
								{
									...
									text_align = "left",
									font_name = "body",
									text = _(string.upper(ctx.prefixes[1]) .. "_EXTRA"),
									colors = {
										text = {
											146,
											25,
					...
					children = {
						{
							...
							children = {
								...
								},
								{
									...
									text_align = "left",
									font_name = "body_bold",
									text = _(string.upper(ctx.prefixes[2]) .. "_NAME"),
									colors = {
										text = {
											24,
											26,
								...
								},
								{
									...
									text_align = "left",
									font_name = "body",
									text = _(string.upper(ctx.prefixes[2]) .. "_EXTRA"),
									colors = {
										text = {
											146,
											25,
