-- chunkname: @./kr5/data/kui_templates/button_shop_offers_spiders.lua
...
return {
	...
	children = {
		...
		{
			template_name = "group_shop_normal_title_dwarves",
			class = "KView",
			id = "MovieClip4669",
			pos = v(-0.65, -174.45),
		...
		},
		{
			...
			children = {
				...
				},
				{
					id = "card_1",
					class = "KView",
					template_name = "group_shop_offer_card_spiders",
					pos = v(-122.55, -2.7)
				},
				{
					id = "card_2",
				...
				},
				{
					id = "multi_card_1",
					class = "KView",
					template_name = "group_card_bundle_spiders",
					pos = v(-128.85, -9.05)
				},
				{
					id = "multi_card_2",
