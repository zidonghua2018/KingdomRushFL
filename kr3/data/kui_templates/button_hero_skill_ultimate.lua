-- chunkname: @./kr5/data/kui_templates/button_hero_skill_ultimate.lua

return {
	default_image_name = "hero_room_image_skill_ultimate_button_bg_0001",
	class = "HeroSkillItemView",
	focus_image_name = "hero_room_image_skill_ultimate_button_bg_0003",
	...
	children = {
		...
		{
			class = "KImageView",
			image_name = "hero_room_image_skill_ultimate_frame_",
			pos = v(-0.1, -0.9),
			anchor = v(57.15, 54.55)
		},
		{
			id = "hero_skill_bullet_1",
			image_name = "hero_room_image_ulti_bullet_off_",
			class = "KImageView",
			pos = v(-26.2, -43.5),
			anchor = v(11.35, 5.95)
		},
		{
			...
			image_name = "hero_room_image_ulti_bullet_select_",
			class = "KImageView",
			pos = v(0.75, -43.5),
			anchor = v(11.3, 5.95)
		},
		{
			...
			image_name = "hero_room_image_ulti_bullet_on_",
			class = "KImageView",
			pos = v(28.1, -43.5),
			anchor = v(11.3, 5.95)
		},
		{
			id = "hero_skill_flash",
			image_name = "hero_room_image_hero_room_ulti_flash_",
			class = "KImageView",
			pos = v(-0.65, -0.05),
		...
		},
		{
			...
			image_name = "hero_room_image_skill_ulti_select_",
			class = "KImageView",
			pos = v(-45.75, -52.85),
			anchor = v(10.85, 8.15)
		},
		...
		},
		{
			...
			image_name = "hero_room_image_skill_ulti_cost_bg_",
			class = "KImageView",
			pos = v(0, 47.75),
			anchor = v(31.2, 16.45)
		},
		...
		},
		{
			...
			image_name = "hero_room_image_skill_ulti_select_full_",
			class = "KImageView",
			pos = v(-45.75, -52.85),
			anchor = v(6.4, 3.9)
		},
