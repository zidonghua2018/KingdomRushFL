-- chunkname: @./kr5/data/kui_templates/group_shop_offers_halloween.lua
...
return {
	...
	children = {
		...
		{
			class = "GG5Button",
			template_name = "button_shop_offers_hw",
		...
		{
			class = "KView",
			template_name = "group_shop_gems_special_offer_title_hw",
			pos = v(-10.75, -267.95)
		},
		{
			class = "KImageView",
			image_name = "shop_room_image_hw_art_right_",
			pos = v(331.35, 77.5),
			anchor = v(199.95, 241.6)
		},
		{
			class = "KImageView",
			image_name = "shop_room_image_hw_art_left_",
			pos = v(-347.2, 49),
			anchor = v(204.15, 290.7)
		}
	}
}
