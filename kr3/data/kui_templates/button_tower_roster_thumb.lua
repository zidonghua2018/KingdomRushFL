-- chunkname: @./kr5/data/kui_templates/button_tower_roster_thumb.lua

return {
	default_image_name = "tower_room_image_roster_thumb_bg_0001",
	class = "TowerSliderItemView",
	focus_image_name = "tower_room_image_roster_thumb_bg_0003",
	...
	children = {
		...
		},
		{
			...
			children = {
				{
					class = "KImageView",
					image_name = "tower_room_image_sale_bg_small_",
					pos = v(-1.65, 1.3),
					anchor = v(37.5, 38.55)
				},
				{
