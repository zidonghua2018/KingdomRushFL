-- chunkname: @./kr5/screen_boss_fight_6_end.lua
...
function screen:next_item()
	...
	if self.phase == "comic12" then
		screen_comics.comic_data = love.filesystem.read(director:get_comic_data_file(12))
