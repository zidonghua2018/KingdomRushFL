-- chunkname: @./kr5/screen_boss_fight_5_end.lua
...
function screen:next_item()
	...
	if self.phase == "comic10" then
		screen_comics.comic_data = love.filesystem.read(director:get_comic_data_file(10))
